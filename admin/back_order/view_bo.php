...
$qry = $conn1->query("SELECT b.*,s.name as supplier,p.po_code FROM back_order_list b inner join supplier_list s on b.supplier_id = s.id inner join purchase_order_list p on b.po_id = p.id  where b.id = '{$_GET['id']}'");
if($qry->num_rows >0){
        ...
        <div class="container-fluid">
            ...
            <table class="table table-striped table-bordered" id="list">
                ...
                <tbody>
                    <?php 
                    $total = 0;
                    $qry = $conn1->query("SELECT b.*,i.name,i.description FROM `bo_items` b inner join item_list i on b.item_id = i.id where b.bo_id = '{$id}'");
