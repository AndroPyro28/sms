...
if(isset($_GET['id'])){
    $qry = $conn1->query("SELECT r.*,s.name as supplier FROM return_list r inner join supplier_list s on r.supplier_id = s.id  where r.id = '{$_GET['id']}'");
    if($qry->num_rows >0){
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <?php 
                            $supplier = $conn1->query("SELECT * FROM `supplier_list` where status = 1 order by `name` asc");
                ...
                <fieldset>
                    ...
                    <div class="row justify-content-center align-items-end">
                            <?php 
                                $item_arr = array();
                                $cost_arr = array();
                                $item = $conn1->query("SELECT * FROM `item_list` where status = 1 order by `name` asc");
                ...
                <table class="table table-striped table-bordered" id="list">
                    ...
                    <tbody>
                        ...
                        $total = 0;
                        if(isset($id)):
                        $qry = $conn1->query("SELECT s.*,i.name,i.description FROM `stock_list` s inner join item_list i on s.item_id = i.id where s.id in ({$stock_ids})");
