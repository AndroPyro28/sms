...
<div class="card card-outline card-primary">
	<div class="card-header">
		<h3 class="card-title">List of Return and Orders</h3>
        ...
        <div class="container-fluid">
			<table class="table table-bordered table-stripped">
                    ...
                    <tbody>
                        <?php 
                        $i = 1;
                        $qry = $conn1->query("SELECT r.*, s.name as supplier FROM `return_list` r inner join supplier_list s on r.supplier_id = s.id order by r.`date_created` desc");
